...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const btnActiveEngine = document.getElementById("btn-active-engine");
    ...
    let allChats = [];
    let currentActiveProvider = "ollama";
    let currentActiveModel = "qwen2.5:3b";
